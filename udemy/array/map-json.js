//Array de JSONs
const bebidas = ['{"name": "Heineken 600ml", "price": 10.63, "rating": 4.6}',
    ...
    const converteJSONparaObject = e => JSON.parse(e);
    const avaliacao = e => e.rating;

    const arrayAvaliacoes = bebidas.map(converteJSONparaObject).map(avaliacao);
